...
const modals: Record<HeaderPageProps["type"], Func> = {
    ...
    "Painel Financeiro": [ModalCreateFuncionario, ["Caixa", "Gerente", "Administrador"]]
  }
...
export const HeaderPage = ({ type }: HeaderPageProps) => {
    ...
    const itemsDropDown = ["Filtro1", "Filtro2", "Filtro3", "Filtro4"];
    ...
    <div className="flex flex-col justify-between ">
        <div className="flex flex-row items-end justify-between ">
            ...
            <button  onClick={() => setCreateIsOpen(true)} className="flex flex-row space-x-2 items-center p-4 text-white bg-indigo-600 rounded-lg m-10">
                ...
                <button className="flex flex-row space-x-2 p-4 text-indigo-600 border-2 border-indigo-600 bg-indigo-200 rounded-lg">
                    ...
                    <div id="dropdownHover" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                     <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton" >
                        ...
                        return (
                            <li key={filtro}>
                                <a href="#" key={filtro} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Dashboard</a>
                            </li>)
        ...
        {/* MODAL AQUI DE TESTE */}
        <ModalComponent ModalType={modalCreateIsOpen} onCloseModal={onCloseCreateModal} />
